...
public final class UIActionDispatcher: ObservableObject {
    ...
    public static let actionNotification = Notification.Name("SwiftAware.UIAction")
    public static let viewAppearedNotification = Notification.Name("SwiftAware.ViewAppeared")
    public static let viewDisappearedNotification = Notification.Name("SwiftAware.ViewDisappeared")
    public static let stateChangedNotification = Notification.Name("SwiftAware.StateChanged")
...
public extension View {
    /// Make view trackable by SwiftAware's ghost UI layer.
