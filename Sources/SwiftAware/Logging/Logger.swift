...
/// Log levels for SwiftAware logging
...
/// Thread-safe logger for SwiftAware
public actor Logger {
    ...
    public init(config: LoggingConfig = LoggingConfig()) {
        ...
        self.osLog = os.Logger(subsystem: "SwiftAware", category: "General")
    }
    ...
    nonisolated public func trace(
        ...
        Task { await log(.trace, message, metadata: metadata, category: "SwiftAware", file: file, function: function, line: line) }
    }
    ...
    nonisolated public func debug(
        ...
        Task { await log(.debug, message, metadata: metadata, category: "SwiftAware", file: file, function: function, line: line) }
    }
    ...
    nonisolated public func info(
        ...
        Task { await log(.info, message, metadata: metadata, category: "SwiftAware", file: file, function: function, line: line) }
    }
    ...
    nonisolated public func warn(
        ...
        Task { await log(.warn, message, metadata: metadata, category: "SwiftAware", file: file, function: function, line: line) }
    }
    ...
    nonisolated public func error(
        ...
        Task { await log(.error, message, metadata: metadata, category: "SwiftAware", file: file, function: function, line: line) }
    }
