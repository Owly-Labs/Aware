    ...
    public var wrappedValue: Value {
        ...
        nonmutating set {
            ...
            if oldValue != newValue {
                ...
                GhostUI.logger.trace("🔄 stateChanged: \(name)", metadata: metadata)
            }
        }
    }
...
public actor StateChangeTracker {
    ...
    public func track<T: AnyObject>(_ object: T, name: String) {
        ...
        GhostUI.logger.trace("🔗 Tracking object: \(name)", metadata: ["type": String(describing: type(of: object))])
    }
    ...
    public func logChange(
        ...
        GhostUI.logger.trace("🔄 stateChanged: \(property)", metadata: [
            "view": viewName,
            "from": from,
            "to": to
        ])
