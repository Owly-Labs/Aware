// AwareStrings.swift
// GhostUI Standards Module
//
// Centralized string patterns for consistent messaging across GhostUI-based apps.
...
/// Centralized string constants for GhostUI-based apps.
