...
public macro AutoLog(
    ...
    category: String? = nil
) = #externalMacro(module: "SwiftAwareMacrosPlugin", type: "AutoLogMacro")
...
public macro AutoLogAll(
    verbosity: AutoLogVerbosity = .standard,
    category: String? = nil
) = #externalMacro(module: "SwiftAwareMacrosPlugin", type: "AutoLogAllMacro")
...
/// ```
@attached(peer)
public macro NoLog() = #externalMacro(module: "SwiftAwareMacrosPlugin", type: "NoLogMacro")
